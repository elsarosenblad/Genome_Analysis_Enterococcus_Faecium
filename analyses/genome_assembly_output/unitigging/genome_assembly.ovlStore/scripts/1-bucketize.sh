...
if [ -e ./genome_assembly.ovlStore.BUILDING/bucket$jobname ] ; then
  echo "Bucketizing job finished; directory './genome_assembly.ovlStore.BUILDING/bucket$jobname' exists."
  exit
fi
